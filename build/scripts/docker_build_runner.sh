...
build()
{
    ...
    # Inside the base dir, there's usually the inner vlc folder then sdk, or just sdk?
    # The extraction command `7zr x ... -o* ...` usually creates `vlc-3.0.21-win64/vlc-3.0.21/sdk`.
    # The glob `*/sdk` handles the inner folder.
    ...
    # We pass OS=Windows to ensuring our Makefile knows what to clean if it uses that var, 
    # though our Makefile just has a generic clean.
    make clean 

    # Build
    # We use the TOOLCHAIN variables.
